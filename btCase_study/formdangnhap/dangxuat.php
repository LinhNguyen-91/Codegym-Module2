...
<body>
    ...
    ?>
    <div class="container">
        <h1 style="color: #000099">Bạn có chắc chắn muốn đăng xuất ?</h1>
        <br>
        <form method='post'>
            <a href="../index.php?controller=khachhang&action=danh_sach&page=<?=$trang?>"><button type="button" class="btn btn-primary">Hủy</button></a>
